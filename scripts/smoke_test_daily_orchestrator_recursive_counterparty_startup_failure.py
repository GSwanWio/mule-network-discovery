"""Validate recursive-counterparty startup failure finalization."""
...
def main() -> None:
    with TemporaryDirectory() as directory:
        ...
        request = SourceLoadRequest.create(
            ...
            state_namespace=(
                "recursive-counterparty-startup-failure"
            ),
        )
        ...
        assert len(ledger_after) == 5
        assert len(recursive_customer_adapter.calls) == 0
        ...
        print("Initial AI calls retained: 5")
